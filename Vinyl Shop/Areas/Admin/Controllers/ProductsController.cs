...
using Vinyl_Shop.Models.ViewModel;
using Vinyl_Shop.Utility;
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            if (ModelState.IsValid)
            {
                ...
                productFromDb.BandName = ProductsVM.Products.BandName;
                productFromDb.Genres = ProductsVM.Products.Genres;
